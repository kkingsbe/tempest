...
| [`coding-guidelines/index/rules-index.md`](skills/coding-guidelines/index/rules-index.md) | Complete 500+ Rust coding rules reference from rust-coding-guidelines project | Deep reference for specific rule lookup during reviews |
...
| [`rust-best-practices/references/`](skills/rust-best-practices/references/) | **Reference chapters (9 files):** Ch1-Styles, Ch2-Clippy, Ch3-Performance, Ch4-ErrorHandling, Ch5-Testing, Ch6-Generics, Ch7-TypeState, Ch8-Docs, Ch9-Pointers | Detailed guidance on specific Rust topics - load relevant chapter based on context |
...
| [`rust-engineer/references/`](skills/rust-engineer/references/) | **Reference guides (5 files):** ownership.md, traits.md, error-handling.md, async.md, testing.md | Deep-dive into specific advanced Rust topics |
...
| [`test-driven-development/testing-anti-patterns.md`](skills/test-driven-development/testing-anti-patterns.md) | Testing anti-patterns reference - avoiding mock testing, test-only methods, incomplete mocks | Writing tests, avoiding common testing mistakes |
