...
- [ ] Fix iced 0.13.x API compatibility in tempest-app
...
- [ ] AGENT QA: Run full build (cargo build --package tempest-app). Fix ALL errors. If green, create '.agent_done_1' with the current date.
